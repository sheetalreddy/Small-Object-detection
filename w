...
#deconv and concat confidence layers for context
    context_layers=[]
    for i in range(1,2):
       concat_name = "{}_mbox_conf{}".format(from_layers[1], conf_postfix)
       concat_name_out = "{}_mbox_conf_out{}".format(from_layers[1], conf_postfix)
       DeConvBNLayer( net, concat_name, concat_name_out, use_batchnorm, True, 256, 20, 0, 1,  lr_mult=lr_mult)
